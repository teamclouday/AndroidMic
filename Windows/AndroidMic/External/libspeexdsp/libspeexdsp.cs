...
{
    using SpeexEchoState = IntPtr;
    using SpeexDecorrState = IntPtr;

    using SpeexPreprocessState = IntPtr;

    // C# binding of libspeexdsp speex_echo.h header
    public sealed class SpeexEcho
    {
        // define library path
        ...
        */
        ...
        public static extern SpeexEchoState speex_echo_state_init(int frame_size, int filter_length);
        ...
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern SpeexEchoState speex_echo_state_init_mc(int frame_size, int filter_length, int nb_mic, int nb_speakers);

        /** Destroys an echo canceller state
         * @param st Echo canceller state
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void speex_echo_state_destroy(SpeexEchoState st);
        ...
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void speex_echo_cancellation(SpeexEchoState st, short[] rec, short[] play, short[] outt);

        // byte array version, as long as audio data is from 16 bit stream
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void speex_echo_cancellation(SpeexEchoState st, byte[] rec, byte[] play, byte[] outt);
        ...
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void speex_echo_capture(SpeexEchoState st, short[] rec, short[] outt);
        ...
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void speex_echo_playback(SpeexEchoState st, short[] play);

        /** Reset the echo canceller to its original state
         * @param st Echo canceller state
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void speex_echo_state_reset(SpeexEchoState st);
        ...
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern int speex_echo_ctl(SpeexEchoState st, int request, IntPtr ptr);
        ...
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern SpeexDecorrState speex_decorrelate_new(int rate, int channels, int frame_size);
        ...
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void speex_decorrelate(SpeexDecorrState st, short[] inn, short[] outt, int strength);

        /** Destroy a Decorrelation state
         * @param st State to destroy
        */
        [DllImport(dllpath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void speex_decorrelate_destroy(SpeexDecorrState st);
    }
